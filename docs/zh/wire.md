...
客户端：逐行解析 NDJSON，把 `TextDelta` 拼到答案区。
...
[`examples/wire_browser/`](https://github.com/SyncLionPaw/pagent/tree/main/examples/wire_browser) — FastAPI + 单页 UI。本站说明：[Wire demo](./wire-demo)。
