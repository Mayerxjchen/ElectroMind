...
Tool-agnostic science and practice. How a specific code stores and runs a force field lives in its tool skill (`tools/lammps`, etc.). A force field is a coupled empirical model, not a bag of independently swappable parameters.
