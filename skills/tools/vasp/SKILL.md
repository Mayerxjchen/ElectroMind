...
| surface reaction kinetics: TST/Eyring rates, adsorption/desorption rates, LH/ER/MvK mechanisms, RDS/TDTS/TDI, BEP, volcano preparation | science: `knowledge/reaction-kinetics.md`; export documented microkinetic inputs for an available external solver |
