...
def dummy_openai_sdk_key(existing: str | None) -> str:
...
class Ollama(Provider):
    ...
    def __init__(
        ...
        resolved_apikey = (
            apikey if apikey is not None else os.getenv(self.API_KEY_ENV_VAR)
        )
        super().__init__(
            model_id,
            base_url=base_url,
            apikey=dummy_openai_sdk_key(resolved_apikey),
